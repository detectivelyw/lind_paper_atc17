...
It follows the basic design principles discussed in Section \ref{lock-in-pop}.
Repy sandbox kernel starts with basic building-block functions and tries to be conservative. 
It was an approximation of leveraging the ``popular paths'', rather than a perfect match. 
